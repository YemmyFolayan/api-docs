...
| Authorization | string | private secret key e.g prod\_sk\_1T1eSavlZxy02OT3OWlvbxK4G |
...
| service | string | Type of services \[ **sms**, **ngn\_wallet**, **kyc\_widget**, **address**, , **AML Monitoring**\]\] |
...
| event\_type | string | event\_type values are **"wallet:event:inter", "wallet:event:intra"** |

> ## 📘
> 
> How to recieve kyc\_widget webhook notification
> 
